 ...
 * @author gyanpatra
 */
public class ProjectDetailsAddForm extends javax.swing.JFrame implements
		KeyListener {
	 ...
	 */
	public ProjectDetailsAddForm() {
		this.projectId = Long.toString(System.currentTimeMillis());

		projectTableController = new ViewerProjectTableController(this);
		projectTableController.addRow(projectId);
	...
	public void addJTables() {
		...
		tableAssociatedHL = new JTable(
				associatedTableController.getTableModel());
		tableAssociatedHL.removeColumn(tableAssociatedHL
	...
	private void initComponents() {
		...
		lblLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/image/Frugal_Blk_BriteRed_small.jpg")));
...

		{
...

			{
				...
				if (btnSaveCounter == 0)
					...
					projectTableController.deleteRow(projectId);
		...
		panelProject.setBorder(javax.swing.BorderFactory
		...
		comboStatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
				"Active", "Completed", "Suspended", "Aborted" }));
		...
		panelLinkMedia.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Hyperlinks & Media"));

		lblAssociatedHyperlink.setText("Associated Hyperlinks");

		btnAddAssociatedLink.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/image/add_icon.png")));
		btnAddAssociatedLink.setText("Add ");
		btnAddAssociatedLink
		...
		btnDeleteAssociatedLink.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/image/delete_icon.png")));
		btnDeleteAssociatedLink.setText("Delete");
		btnDeleteAssociatedLink
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		tableAssociatedHL.setModel(new javax.swing.table.DefaultTableModel(
				...
				}, new String[] { "Associated Link" }));
		scrollPaneAssociated.setViewportView(tableAssociatedHL);

		javax.swing.GroupLayout paneAssociatedLinkLayout = new javax.swing.GroupLayout(
				paneAssociatedLink);
		paneAssociatedLink.setLayout(paneAssociatedLinkLayout);
		paneAssociatedLinkLayout
				.setHorizontalGroup(paneAssociatedLinkLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneAssociatedLinkLayout
								...
								paneAssociatedLinkLayout
										...
										.addGroup(
												paneAssociatedLinkLayout
														...
														.addContainerGap())));
		paneAssociatedLinkLayout
				.setVerticalGroup(paneAssociatedLinkLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneAssociatedLinkLayout
		...
		btnAddDirectLink.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/image/add_icon.png")));
		...
		btnDeleteDirectLink.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/image/delete_icon.png")));
		...
		tableDirectHL.setModel(new javax.swing.table.DefaultTableModel(
				...
				}, new String[] { "Direct Link" }));
		scrollPaneDirect.setViewportView(tableDirectHL);

		javax.swing.GroupLayout paneDirecLinkLayout = new javax.swing.GroupLayout(
				paneDirecLink);
		paneDirecLink.setLayout(paneDirecLinkLayout);
		paneDirecLinkLayout
				.setHorizontalGroup(paneDirecLinkLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneDirecLinkLayout
										...
										.addGroup(
												paneDirecLinkLayout
														...
														.addComponent(
																...
																Short.MAX_VALUE))));
		paneDirecLinkLayout
				.setVerticalGroup(paneDirecLinkLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneDirecLinkLayout
		...
		jScrollPane7.setViewportView(tableMedia);

		btnAddMedia.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/image/add_icon.png")));
		...
		btnDeleteMedia.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/image/delete_icon.png")));
		...
		javax.swing.GroupLayout paneMediaLayout = new javax.swing.GroupLayout(
				paneMedia);
		paneMedia.setLayout(paneMediaLayout);
		paneMediaLayout
				.setHorizontalGroup(paneMediaLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneMediaLayout
										...
										.addContainerGap()));
		paneMediaLayout
				.setVerticalGroup(paneMediaLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneMediaLayout
		...
		panelTeam.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Team"));

		lblAdvisor.setText("Advisors");

		btnAddAdvisor.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/image/add_icon.png")));
		...
		tableAdvisor.setModel(new javax.swing.table.DefaultTableModel(
				...
				}, new String[] { "Advisor Name" }));
		scrollPaneAdvisor.setViewportView(tableAdvisor);

		btnDeleteAdvisor.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/image/delete_icon.png")));
		...
		btnAddStudent.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/image/add_icon.png")));
		...
		btnDeleteStudent.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/image/delete_icon.png")));
		...
		javax.swing.GroupLayout panelStudentsLayout = new javax.swing.GroupLayout(
				panelStudents);
		panelStudents.setLayout(panelStudentsLayout);
		panelStudentsLayout
				.setHorizontalGroup(panelStudentsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelStudentsLayout
										...
										.addContainerGap()));
		panelStudentsLayout
				.setVerticalGroup(panelStudentsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelStudentsLayout
		...
		btnAddPartner.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/image/add_icon.png")));
		...
		jScrollPane5.setViewportView(tablePartners);

		btnDeletePartner.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/image/delete_icon.png")));
		...
		panelScopeLocation.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Scope of Work & Location of Prototype"));

		javax.swing.GroupLayout paneScopeLayout = new javax.swing.GroupLayout(
				paneScope);
		paneScope.setLayout(paneScopeLayout);
		paneScopeLayout.setHorizontalGroup(paneScopeLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				paneScopeLayout
						.createSequentialGroup()
						.addContainerGap()
						.addComponent(txtScopeofWork,
								javax.swing.GroupLayout.DEFAULT_SIZE, 587,
								Short.MAX_VALUE).addContainerGap()));
		paneScopeLayout.setVerticalGroup(paneScopeLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				paneScopeLayout
						.createSequentialGroup()
						.addContainerGap()
		...
		javax.swing.GroupLayout paneLocationLayout = new javax.swing.GroupLayout(
				paneLocation);
		paneLocation.setLayout(paneLocationLayout);
		paneLocationLayout
				.setHorizontalGroup(paneLocationLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneLocationLayout
										...
										.addContainerGap()));
		paneLocationLayout
				.setVerticalGroup(paneLocationLayout.createParallelGroup(
						javax.swing.GroupLayout.Alignment.LEADING).addGroup(
						paneLocationLayout
								.createSequentialGroup()
								.addContainerGap()
								.addComponent(txtLocationPrototype,
										javax.swing.GroupLayout.DEFAULT_SIZE,
	...
	private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSaveActionPerformed
		if (txtName.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Project should have a name",
					"Can't edit project", JOptionPane.ERROR_MESSAGE);
		} else if (dateStartDate.getDate() == null) {
			JOptionPane.showMessageDialog(null, "Start Date should be filled",
					"Can't edit project", JOptionPane.ERROR_MESSAGE);
		}

		else if (dateEndDate.getDate() != null
				&& dateStartDate.getDate().after(dateEndDate.getDate())) {
			...
			projectTableController.updateRow(projectId, name, status, theme,
					scope, startDate, endDate, location);
			studentTableController.addStudent(projectId, listStudentId,
					listStudentName);
			facultyTableController.addFaculty(projectId, listAdvisorId,
					listAdvisorName);
			partnerTableController.addPartner(projectId, listPartnerName);
			mediaTableController.addMedia(projectId, listMediaName,
					listMediaPath);
	...
	private void btnAddAdvisorActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAddAdvisorActionPerformed
		...
		if (advisorId != null && advisorId != "") {
			...
			Faculty advisor = advisorModel.getValidAdvisor(advisorId
					.toLowerCase());
	...
	private void btnAddStudentActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAddStudentActionPerformed
		...
		if (studentId != null && studentId != "") {
			...
			// check if the student id is present in the data base or not
			// if present append the name and student id
			Student student = studentModel.getValidStudent(studentId
					.toLowerCase());
			if (student != null) {
				// studentTableController.addStudent(projectId);
				listStudentId.add(student.getStudentId());
				listStudentName.add(student.getName());

				// DefaultTableModel studentTableModel = (DefaultTableModel)
				// tableStudent.getModel();
				studentTableModel.addRow(new Object[] { student.getName() });
				// projectStudentList.add(student.getStudentId());
				// txtAreaStudents.append(student.getStudentId() +" Name :"
				// +student.getName()+"\n");
			} else {
	...
	private void btnAddPartnerActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAddPartnerActionPerformed
		...
		if (partnerName != null && partnerName != "") {
			...
			// DefaultTableModel model = (DefaultTableModel)
			// tablePartners.getModel();
			partnerTableModel.addRow(new Object[] { partnerName });

		}
	}// GEN-LAST:event_btnAddPartnerActionPerformed

	private void txtLocationPrototypeActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_txtLocationPrototypeActionPerformed
		// TODO add your handling code here:
	}// GEN-LAST:event_txtLocationPrototypeActionPerformed

	private void btnAddAssociatedLinkActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAddAssociatedLinkActionPerformed
		if (btnSaveCounter == 0) {
			JOptionPane.showMessageDialog(null,
					"Please save the project first", "Can't add hyperlink",
			...
			if (path != null) {
				try {
					...
					JOptionPane.showMessageDialog(null,
							...
							"Can't add hyperlink", JOptionPane.ERROR_MESSAGE);
				}
			}
		}
	...
	private void btnAddDirectLinkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAddDirectLinkActionPerformed
		if (btnSaveCounter == 0)
			...
			if (path != null)
				try {
					directTableController.addRow(path, projectId, "direct");
				} catch (javax.persistence.RollbackException exp) {
					JOptionPane.showMessageDialog(null,
							"This hyperlink already exists in the system",
							"Can't add hyperlink", JOptionPane.ERROR_MESSAGE);
	...
	private void btnDeleteAssociatedLinkActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteAssociatedLinkActionPerformed
	...
	private void btnDeleteDirectLinkActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteDirectLinkActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(
					ProjectDetailsAddForm.class.getName()).log(
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new ProjectDetailsAddForm().setVisible(true);
			}
		});
	}

	/*
	 * public void initComboBox(){ String[] status = { "Active", "Completed",
	 * "Suspended", "Aborted"};
	 * 
	 * 
	 * jComboBox1.addItem(jComboBox1); jComboBox1.setSelectedIndex(4);
